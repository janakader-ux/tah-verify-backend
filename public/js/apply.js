...
(function () {
  ...
  function generateLetterPdf() {
    ...
    const bodySections = [
      ...
      ['2. Fee', 'Our fee for this service is ' + feeText + '. Payment is due after signing the engagement letter and submitting this application and before we open your identity verification link or confirm an appointment, and is collected securely online.'],
      ['3. How your identity will be verified', 'No document upload or account registration is required on this website. After payment, ' + routeText + '. If you are not resident in the United Kingdom, your identity document must be government-issued. All documents must be seen in their original form.'],
